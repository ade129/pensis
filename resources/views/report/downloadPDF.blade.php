...
<body>
	<div class="container" style="text-align: center;">
		<table width="100%" >
			<tbody>
				<tr>
					<td width="20%"><img src="https://i.ibb.co/0BJ1WZR/uninet-media-sakti-pt-fb.gif" width="150;" alt=""></td>
					<td style="margin:40px;">
						<h2 >PT. Uninet Media Sakti</h2>	
						<p>Graha Uninet, No. 25, Jl. Warung Buncit Raya <span style="display: block;">RT.2/RW.7 West Pejaten, Pasar Minggu, South Jakarta City, Jakarta 12510 </span><span style="display: block">Telpon :  (021) 7940911</span></p>
						<p></p>
					</td>
				</tr>
			</tbody>
